...
class SwingFootPlanner : public System::Source<SwingFootPlannerState>
{
    ...
    std::unique_ptr<Spline> m_planarPlanner; /**< Trajectory planner for the x y coordinates of the foot */
    std::unique_ptr<Spline> m_heightPlanner; /**< Trajectory planner for the z coordinate of the foot */
